...
function renderGrid(schoolStart) {
	...
	// browseOutput += '</div>';
	browseOutput += '<div class="lgi"></div>';
	browseOutput += '<div class="lgi browse" value="-7"><img height="16px" src="/cfpimages/browse-left-double.png" /></div>';
	browseOutput += '<div class="lgi browse" value="-1"><img height="16px" src="/cfpimages/browse-left-single.png" /></div>';
	browseOutput += '<div class="lgi browse" value="-1"><img height="16px" src="/cfpimages/browse-left-single.png" /></div>';
	browseOutput += '<div class="lgi browse" value="-1"><img height="16px" src="/cfpimages/browse-left-single.png" /></div>';
	browseOutput += '<div class="lgi">Browse</div>';
	browseOutput += '<div class="lgi browse" value="1"><img height="16px" src="/cfpimages/browse-right-single.png" /></div>';
	browseOutput += '<div class="lgi browse" value="1"><img height="16px" src="/cfpimages/browse-right-single.png" /></div>';
	browseOutput += '<div class="lgi browse" value="7"><img height="16px" src="/cfpimages/browse-right-double.png" /></div>';
		...
		for (let link of GridData["SITES"]["DATA"]) {        
			...
			if (link[1] == "Link") {
				if (link[4] == "") {
					// Expander   
					if (link[9] > 0) {
						// gridOutput += ' <div id="Row' + link[3] + '" value="' + link[3] + '" class="GridRow ' + firstPass + '"><div class="lgi GridCell"> <p> <img id="expand_subrow' + link[3] + '" class="sectionExpand" src="/cfpimages/expand.jpg" title="Expand to view subsections of this site" /><img id="collapse_subrow' + link[3] + '" class="sectionCollapse" src="/cfpimages/collapse.jpg" title="Collapse subsections" /> &nbsp; ';
						gridOutput += '<div class="lgi GridCell"> <p> <img id="expand_subrow' + link[3] + '" class="sectionExpand" src="/cfpimages/expand.jpg" title="Expand to view subsections of this site" /><img id="collapse_subrow' + link[3] + '" class="sectionCollapse" src="/cfpimages/collapse.jpg" title="Collapse subsections" /> &nbsp; ';
					} else {
						// No Sublinks
						// gridOutput += ' <div value="' + link[3] + '" class="GridRow ' + firstPass + '"><div class="lgi GridCell nosublink"> <p> <img src="" />';
						gridOutput += '<div class="lgi GridCell nosublink"> <p> <img src="" />';
					}
					// Icon
					if (link[7].length > 0) {
					...
					// Sublink Row
					// gridOutput += '<div value="' + link[3] + '" class="GridRow ' + firstPass + ' sublink subrow' + link[4] + '"><div class="lgi GridCell sublink2"><span class="SublinkName">' + link[8] + '</span></div>';
					gridOutput += '<div class="lgi GridCell sublink2"><span class="SublinkName">' + link[8] + '</span></div>';
				}
				for (let school of schools) {
					if (GridData["MISSINGSLUGS"].hasOwnProperty(link[6])) {
						if (GridData["MISSINGSLUGS"][link[6]].indexOf(school[2]) == -1) {
							gridOutput += '<div class="lgi jump" value="' + school[2] + '"><img /></div>';
						} else {
							gridOutput += '<div class="lgi nojump"><img /></div>';
						}
					} else {
						gridOutput += '<div class="lgi jump" value="' + school[2] + '"><img /></div>';
					} 
				...
				// gridOutput += ' <div id="Row' + link[0] + '" class="GridRow ' + firstPass + ' GridRowHeader"><div class="lgi GridCell"> <p> <img id="expand_subrow' + link[3] + '" class="sectionExpand" src="/cfpimages/expand.jpg" title="Expand to view subsections of this site" height="12" /><img id="collapse_subrow' + link[3] + '" class="sectionCollapse" src="/cfp`images/collapse.jpg" title="Collapse subsections" height="12" /> &nbsp; <span class="SiteName">' + link[8] + '</span></p></div></div>';
				gridOutput += ' <div class="lgi GridCell"> <p> <img id="expand_subrow' + link[3] + '" class="sectionExpand" src="/cfpimages/expand.jpg" title="Expand to view subsections of this site" height="12" /><img id="collapse_subrow' + link[3] + '" class="sectionCollapse" src="/cfp`images/collapse.jpg" title="Collapse subsections" height="12" /> &nbsp; <span class="SiteName">' + link[8] + '</span></p></div>';
			}
	...
	// $("#idWidget2").html(browseOutput);
	// $("#idWidget2").append(headerOutput); // .after(gridOutput);
	// $("#idWidget2").after(gridOutput);
