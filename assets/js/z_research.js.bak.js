...
function renderGrid(schoolStart) {
	...
	for (let school of schools) {
		left_offset += 50;
		headerOutput += '<div class="GridHeader widget-header2" value="' + school[2] + '"><div class="header-content" style="margin-left:' + left_offset + 'px;"><img class="SchoolIcon" src="/cfpimages/school/icons/batch/' + school[1].replace("jpg", "png") + '" title="" schoolid="' + school[2] + '" /> <span class="SchoolName">' + school[0] + '</span></div></div>';
	}
